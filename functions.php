...
function alkali_friday_scripts() {
	...
	wp_enqueue_style('alkali-underscore-bootstrap', get_template_directory_uri() . '/css/bootstrap.min.css', array(), '5.0.1', 'all');
	wp_enqueue_style('alkali-underscore-fontawesome', get_template_directory_uri() . '/css/all.min.css', array(), '5.15.3', 'all');
	...
	wp_enqueue_script('alklai-underscores-bootstrap-js', get_template_directory_uri() . '/js/bootstrap.min.js', array(), '5.0.1', true);
